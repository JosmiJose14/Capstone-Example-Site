    ...
    <div id="container">
      ...
      <div className="divCarousel">
        <Carousel showThumbs={false}>
          <div>
            <img src={carousel} style={{ width: "80%", height: "50%" }} alt="hair with flair salon wall print 1" />
          </div>
          <div>
            <img src={carousel1} style={{ width: "80%", height: "50%" }} alt="hair with flair salon wall print 2" />
          </div>
          <div>
            <img src={carousel2} style={{ width: "80%", height: "50%" }} alt="hair with flair salon wall print 3" />
          </div>
        </Carousel>
      </div>
      ...
      <div className="service-container sidepadding">
        <div className="service-section">
          ...
          <Link type="button" id="buttons" className="btnService" style={{ textDecoration: "none" }} to="/Appointments"  target="_self">Book an appointment</Link>
        </div>
        <div className="service-section">
